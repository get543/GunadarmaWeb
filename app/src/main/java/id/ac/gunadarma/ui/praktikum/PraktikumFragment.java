package id.ac.gunadarma.ui.praktikum;
...
import id.ac.gunadarma.databinding.FragmentPraktikumBinding;
import id.ac.gunadarma.viewmodel.BaseWebViewFragment;
import id.ac.gunadarma.viewmodel.BaseWebViewModel;

public class PraktikumFragment extends BaseWebViewFragment {

    private FragmentPraktikumBinding binding; // Using View Binding is best practice

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentPraktikumBinding.inflate(inflater, container, false);
    ...
    protected WebView getWebView() {
        return binding.PraktikumWebView;
    }
